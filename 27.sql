-- Practice Question 
-- Q27.Write a query to find how many songs are performed by each artist whose name contains the letter o.
...
select artist ,count(*) from songs where artist like "%o%" group by artist;